...
public class GameBurza {
    ...
    private static void initializeVideoGames(){
        ...
        games.add(new VideoGameModel("The Legend of Zelda: Breath of the Wild", 2017, "An open-world action-adventure game in a vast, post-apocalyptic Hyrule.", "Nintendo eShop", "Adventure", (float) 3359.44, ""));
        games.add(new VideoGameModel("Life is Strange", 2015, "A graphic adventure game that follows a young girl with time-manipulation powers.", "Steam", "Adventure", (float) 1119.44, ""));
        games.add(new VideoGameModel("The Witcher 3: Wild Hunt", 2015, "An open-world RPG where Geralt of Rivia battles monsters and searches for his adopted daughter.", "Steam", "RPG", (float) 2239.44, ""));
        ...
        games.add(new VideoGameModel("Civilization VI", 2016, "A turn-based strategy game where players build and manage an empire through the ages.", "Steam", "Strategy", (float) 1679.44, "/images/thesims4.png"));
        ...
        games.add(new VideoGameModel("Resident Evil Village", 2021, "A survival horror game where players battle through a village terrorized by monsters.", "Steam", "Horror", (float) 3359.44, "/images/residentevilvillage.webp"));
    ...
    private static void initializeCredits() {
        ...
        GameBurza.credits.add(new CreditsModel("PlayStation Network (PSN) Wallet Top-up", availableDenominations, 2020, "Top up your PSN wallet to purchase games, DLCs, and subscriptions.", "PSN", (float) 500.00));
        GameBurza.credits.add(new CreditsModel("Steam Wallet Gift Card (Digital Code)", availableDenominations, 2019, "Redeemable Steam Wallet funds for games, DLCs, and in-game purchases.", "Steam", (float) 550.00));
        GameBurza.credits.add(new CreditsModel("Garena Shells Scratch Card", availableDenominations, 2018, "Prepaid scratch cards for Garena games like League of Legends and Call of Duty.", "Garena", (float) 450.00));
        GameBurza.credits.add(new CreditsModel("Google Play Gift Card (Physical)", availableDenominations, 2021, "Purchase apps, games, movies, and more from the Google Play Store.", "Google Play", (float) 600.00));
